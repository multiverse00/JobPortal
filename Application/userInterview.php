                    ...
                    <div class="d-flex mb-4">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table id="example2" class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM interview INNER JOIN employer ON interview.employer_id = employer.employer_id WHERE interview.job_seeker_id = '$_SESSION[job_seeker_id]'";
                                        if (!empty($search)) {
                                       ...
                                       $result = $conn->query($sql);
                                        ...
                                        ?>
                                        <tr>
                                         <td><?php echo $row['companyName']; ?> <br> <?php echo $row['title']; ?></td> 
                                          <td><?php echo $row['interview_date'] ?></td>
    
                                          <td><a class = "btn btn-success" href="showInterview.php?id=<?php echo $row['interview_id']; ?>">View</a></td>
