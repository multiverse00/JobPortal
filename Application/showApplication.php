                                    ...
                                    <tbody>
                                        ...
                                        if($result->num_rows > 0) {
                                          while($row = $result->fetch_assoc()) {
                                            $sql1 = "SELECT * FROM application WHERE job_id = '$row[job_id]'";
                                            $result1 = $conn->query($sql1);
                                            if($result1->num_rows > 0) {
                                                while($row1 = $result1->fetch_assoc()) {
                                        ?>
                                        <tr>
                                          <td><?php echo $row1['job_id']; ?></td>
                                          <td><?php echo $row['job_title']; ?></td>

                                         
                                          <td><a class = "btn btn-info" href="reviewApplication.php?id=<?php echo $row1['job_seeker_id'];?>&job_id=<?php echo $row['job_id']; ?>">View Application</a></td>
