                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         <td><?php echo $row['author_id']; ?></td> 
                                          ...
                                          <td><a class = "btn btn-success" href="adminviewFeedback.php?id=<?php echo $row['id']; ?>">View</a></td>
                                         <td><a class = "btn btn-danger" href="adminDeletefeedback.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this feedback?');">Delete</a></td>
                                         </tr>  
                                          <?php
                                          }
                                        }
