                ...
                <div class="col-md-9 ">
                    ...
                    <div class="d-flex mb-4">
                            <form  action="" method="GET" class="w-50 d-flex ms-auto">
                                <input type="text" name="search" class="form-control me-2" placeholder="Category" value="<?php echo ($search); ?>">
                                    ...
                                    <tbody>
                                        ...
                                        <td><?php echo $row['category_id']; ?></td> 
                                         <td><?php echo $row['category_name']; ?></td> 
                                          ...
                                          <td><a class = "btn btn-success" href="editCategory.php?id=<?php echo $row['category_id']; ?>">Update</a></td>
                                         <td><a class = "btn btn-danger" href="deleteCategory.php?id=<?php echo $row['category_id']; ?>" onclick="return confirm('Are you sure you want to delete this category?');">Delete</a></td>
                                         </tr>  
                                          <?php
                                          }
                                        }
